        ...
        if arguments.history:
            ...
            if arguments.history == "clear":
                ...
                while True:
                    ...
                    items = dict()
                    if not int(command):
                        print("{:<4} {:<8} {:<30} {:<30} {:<30} {:<8}".format(
                            '..', 'Method', 'URL', 'Params', 'Request body',
                            'status'))
            ...
            if arguments.auth: auth = tuple(arguments.auth)
            else: auth = None
            ...
            result = rapi(arguments.endpoint,
