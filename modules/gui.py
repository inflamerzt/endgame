...
def rungui():
    ...
    loglvl1 = tk.Radiobutton(loglvl,
                             text="Debug",
                             variable=loglvlvar,
                             value=0,
                             bg="blue",
                             command=lambda: setloglevel('DEBUG')).grid(
                                 column=0, row=0)
    loglvl2 = tk.Radiobutton(loglvl,
                             text="Info",
                             variable=loglvlvar,
                             value=1,
                             bg="green",
                             command=lambda: setloglevel('INFO')).grid(
                                 column=1, row=0)
    loglvl3 = tk.Radiobutton(loglvl,
                             text="Warning",
                             variable=loglvlvar,
                             value=2,
                             bg="yellow",
                             command=lambda: setloglevel('WARNING')).grid(
                                 column=2, row=0)

    loglvl4 = tk.Radiobutton(loglvl,
                             text="Error",
                             variable=loglvlvar,
                             value=3,
                             bg="red",
                             command=lambda: setloglevel('ERROR')).grid(
                                 column=3, row=0)
    ...
    rvmode2 = tk.Radiobutton(rvmode,
                             text="Pretty JSON",
                             variable=rvmodevar,
                             value=1,
                             command=lambda: viewdata()).grid(column=1, row=0)
    rvmode3 = tk.Radiobutton(rvmode,
                             text="YAML",
                             variable=rvmodevar,
                             value=2,
                             command=lambda: viewdata()).grid(column=2, row=0)
    rvmode4 = tk.Radiobutton(rvmode,
                             text="Treeview/Table",
                             variable=rvmodevar,
                             value=3,
                             command=lambda: viewdata()).grid(column=3, row=0)
